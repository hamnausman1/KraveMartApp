import svgPaths from "./svg-5to5z6flg7";
...
import { imgMain1 } from "./svg-yjxht";
  ...
  return (
    <div className="absolute h-[25px] left-[16px] overflow-clip top-[calc(50%-0.5px)] translate-y-[-50%] w-[276px]" data-name="Group">
      ...
      <div className="absolute bottom-0 flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] left-[15.94%] not-italic opacity-[0.87] right-[-2.9%] text-[#37474f] text-[16px] top-[4%] tracking-[0.44px]">
        <p className="leading-[normal]">03XX-XXXXXXX</p>
      </div>
    </div>
  );
}
...
export default function SplashPhoneNumber() {
  return (
    <div className="bg-white relative size-full" data-name="Splash--Phone Number">
      ...
      <div className="absolute flex flex-col font-['Poppins:Medium',sans-serif] inset-[55.67%_25.87%_40.64%_4.27%] justify-center leading-[0] not-italic text-[#37474f] text-[20px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">Enter your mobile number</p>
      </div>
      <p className="absolute font-['Poppins:Regular',sans-serif] inset-[60.59%_4.27%_32.88%_4.27%] leading-[normal] not-italic text-[14px] text-[rgba(55,71,79,0.72)]">{`We need to verify you. We will send you a one time verification code. `}</p>
      <ButtonsMobileSolidTextSymbolTextSymbol />
      <div className="absolute aspect-[222/227] left-[91.73%] right-[4%] top-[44px]" data-name="image 31">
