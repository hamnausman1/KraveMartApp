import svgPaths from "./svg-gurxfnb77x";
import imgMain2 from "figma:asset/db4e58fac23dd6eaeefc5f9b23a040409692e76a.png";
import imgRectangle1 from "figma:asset/062eeca10a802eee1c012aade3421573bbfd999b.png";
import imgRectangle2 from "figma:asset/63a25816531ff80d90be2876c1dd71ec42c15207.png";
import imgRectangle3 from "figma:asset/976732cc8700a986b169e5fc726b621dbc00cfd3.png";
import imgRectangle4 from "figma:asset/692b0117404b06af64b0cfeef981346e03f367bd.png";
import imgRectangle5 from "figma:asset/b14947218527d4153b948bcf72c2655fe0a6b493.png";
import imgRectangle6 from "figma:asset/acc082d48cd4df4ab364b5bc0ae61109094e50e7.png";
import imgRectangle7 from "figma:asset/8d1068416186af0bd446306eeac82b08e2ed6168.png";
import imgRectangle8 from "figma:asset/0e93e43d12ea8cf1ae143f65616c31cb97b013b8.png";
import imgImage31 from "figma:asset/d1a81c329997884332855549bf84957646c3655b.png";
import { imgMain1 } from "./svg-7ewyg";
...
function ComponentsMobileAppbarSecondery() {
  ...
  return (
    <div className="absolute h-[88px] left-0 top-0 w-[375px]" data-name="components/mobile/appbar/secondery">
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[58px] not-italic text-[#37474f] text-[20px] text-nowrap top-[47.32px] whitespace-pre">{t('fruits')}</p>
  ...
  return (
    <div className="absolute h-[293px] left-[16px] top-[121px] w-[164px]" data-name="card/product/normal">
      ...
      <div className="absolute bottom-[28.33%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">
        <p className="mb-0">Surf Excel Detergent Powder</p>
        <p>1 kg</p>
      </div>
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-[62.8%] text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">Rs. 550</p>
...
function CardProductNormal2() {
  return (
    <div className="absolute h-[293px] left-[195px] top-[121px] w-[164px]" data-name="card/product/normal">
      ...
      <p className="absolute bottom-[42.66%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">Brite Maximum Power...</p>
...
function Alert() {
  return (
    <div className="absolute bottom-0 contents left-[0.03%] right-[-0.02%] top-[0.02%]" data-name="Alert">
      <Group6 />
      <Group8 />
    </div>
  );
...
function ComponentsMobileAppbarSecondery1() {
  ...
  return (
    <div className="absolute h-[88px] left-0 top-0 w-[375px]" data-name="components/mobile/appbar/secondery">
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[58px] not-italic text-[#37474f] text-[20px] text-nowrap top-[47.32px] whitespace-pre">{t('cleaningAndLaundry')}</p>
...
function CardProductNormal4() {
  return (
    <div className="absolute h-[293px] left-[16px] top-[121px] w-[164px]" data-name="card/product/normal">
      ...
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-full text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">&nbsp;</p>
      <ButtonsWebSolidTextSymbolSymbolText4 />
    </div>
  );
}

function ActionBag24Px5() {
  return (
    <div className="absolute left-[17px] size-[14px] top-[calc(50%+0.5px)] translate-y-[-50%]" data-name="action/bag_24px">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="action/bag_24px ">
...
function ButtonsWebSolidTextSymbolSymbolText5() {
  return (
    <div className="absolute bg-[#ffd037] bottom-0 left-0 right-0 rounded-[7px] top-[88.05%]" data-name="buttons/web/solid/text + symbol/symbol → text">
      <ActionBag24Px5 />
      <Frame5 />
...
function CardProductNormal5() {
  return (
    <div className="absolute h-[293px] left-[16px] top-[465px] w-[164px]" data-name="card/product/normal">
      <div className="absolute bg-[#f3f4f4] bottom-[53.92%] left-0 right-0 rounded-[9px] top-0" />
      <div className="absolute inset-[1.71%_15.24%_57%_14.63%] rounded-[9px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[9px] size-full" src={imgRectangle5} />
      </div>
      <div className="absolute bottom-[35.49%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">
        <p className="mb-0">Ariel Washing Powder</p>
        <p>500g</p>
      </div>
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-[62.8%] text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">Rs. 580</p>
      <ButtonsWebSolidTextSymbolSymbolText5 />
    </div>
  );
}

function ActionBag24Px6() {
  return (
    <div className="absolute left-[17px] size-[14px] top-[calc(50%+0.5px)] translate-y-[-50%]" data-name="action/bag_24px">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="action/bag_24px ">
...
function ButtonsWebSolidTextSymbolSymbolText6() {
  return (
    <div className="absolute bg-[#ffd037] bottom-0 left-0 right-0 rounded-[7px] top-[88.05%]" data-name="buttons/web/solid/text + symbol/symbol → text">
      <ActionBag24Px6 />
      <Frame6 />
...
function CardProductNormal6() {
  return (
    <div className="absolute h-[293px] left-[195px] top-[121px] w-[164px]" data-name="card/product/normal">
      <div className="absolute bg-[#f3f4f4] bottom-[53.92%] left-0 right-0 rounded-[9px] top-0" />
      <div className="absolute inset-[1.71%_15.24%_57%_14.63%] rounded-[9px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[9px] size-full" src={imgRectangle6} />
      </div>
      <div className="absolute bottom-[35.49%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">
        <p className="mb-0">&nbsp;</p>
        <p>1 kg</p>
      ...
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-full text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">&nbsp;</p>
      <ButtonsWebSolidTextSymbolSymbolText6 />
    </div>
  );
}

function ActionBag24Px7() {
  return (
    <div className="absolute left-[17px] size-[14px] top-[calc(50%+0.5px)] translate-y-[-50%]" data-name="action/bag_24px">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="action/bag_24px ">
...
function ButtonsWebSolidTextSymbolSymbolText7() {
  return (
    <div className="absolute bg-[#ffd037] bottom-0 left-0 right-0 rounded-[7px] top-[88.05%]" data-name="buttons/web/solid/text + symbol/symbol → text">
      <ActionBag24Px7 />
      <Frame7 />
...
function CardProductNormal7() {
  return (
    <div className="absolute h-[293px] left-[195px] top-[465px] w-[164px]" data-name="card/product/normal">
      <div className="absolute bg-[#f3f4f4] bottom-[53.92%] left-0 right-0 rounded-[9px] top-0" />
      <div className="absolute inset-[1.71%_15.24%_57%_14.63%] rounded-[9px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[9px] size-full" src={imgRectangle7} />
      </div>
      <p className="absolute bottom-[42.66%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">Bonus Washing Powder</p>
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-[62.2%] text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">Rs. 600</p>
      <ButtonsWebSolidTextSymbolSymbolText7 />
    </div>
  );
}
...
export default function CleaningAndLaundryHome() {
  const { language } = useLanguage();
  return (
    <div className="bg-white relative size-full" data-name="Cleaning and Laundry home">
      <MaskGroup />
      ...
      <Tabs />
      <Menu />
      <div className="absolute inset-[15.52%_58.67%_69.58%_10.67%] rounded-[9px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[9px] size-full" src={imgRectangle8} />
      </div>
      <Content />
      <div className="absolute left-[342px] size-[16px] top-[53px]" data-name="image 31">
