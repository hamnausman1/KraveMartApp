import svgPaths from "./svg-nb7zouuzw6";
...
import { imgMain1 } from "./svg-wy0ok";
...
function Group1() {
  return (
    <button className="absolute block cursor-pointer inset-[4.56%_47.2%_91.63%_4.27%]" data-name="Group">
...
export default function SplashPhoneNumberPreregisterd() {
  return (
    <div className="bg-white relative size-full" data-name="Splash--Phone Number--Preregisterd">
      ...
      <div className="absolute flex flex-col font-['Poppins:Medium',sans-serif] inset-[55.67%_44%_40.64%_4.27%] justify-center leading-[0] not-italic text-[#37474f] text-[20px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">Enter the password</p>
      </div>
      <p className="absolute font-['Poppins:Regular',sans-serif] inset-[60.59%_4.27%_32.88%_4.27%] leading-[normal] not-italic text-[14px] text-[rgba(55,71,79,0.72)]">Please enter the password to proceed</p>
      <p className="absolute font-['Poppins:Regular',sans-serif] inset-[81.28%_61.87%_16.13%_4.27%] leading-[normal] not-italic text-[#f37a20] text-[14px] text-nowrap whitespace-pre">{`Forgot  Password?`}</p>
