import svgPaths from "./svg-jrnbnpx9o8";
...
import { imgMain1 } from "./svg-7dh31";
...
function BarsHomeIndicatorIPhoneLightPortrait() {
  return (
    <div className="absolute inset-[96.42%_31.73%_0.01%_32.53%]" data-name="Bars / Home Indicator / iPhone / Light - Portrait">
...
export default function OrderScheduledConfirmed() {
  return (
    <div className="bg-white relative size-full" data-name="Order--Scheduled--confirmed">
      <MaskGroup />
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[59px] not-italic text-[#37474f] text-[32px] text-nowrap top-[157px] tracking-[1.28px] whitespace-pre">50 - 60 mins</p>
      <ActionEvent24Px />
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[17px] not-italic text-[#777777] text-[16px] text-nowrap top-[242px] tracking-[0.44px] whitespace-pre">Your order is confirmed</p>
      <Group4 />
      ...
      <div className="absolute h-[28px] left-[33px] top-[769px] w-[42px]" data-name="image 14">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage14} />
      </div>
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[21px] leading-[normal] left-[79px] not-italic text-[#37474f] text-[14px] top-[480px] w-[131px]">IBA Main Campus</p>
      <div className="absolute left-[344px] size-[16px] top-[49px]" data-name="image 28">
