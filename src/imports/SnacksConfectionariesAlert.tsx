import svgPaths from "./svg-uyuufjcxuz";
import imgMain2 from "figma:asset/db4e58fac23dd6eaeefc5f9b23a040409692e76a.png";
import imgRectangle1 from "figma:asset/3552cc91b658b2025205e0d3f3bc1004ed92e256.png";
import imgRectangle2 from "figma:asset/9009f0677ddc15cf063c6d768ca044df5d9cf4f2.png";
import imgRectangle3 from "figma:asset/6b8b21698640fe0f9a7033a6db025cbe75d0a4d1.png";
import imgRectangle4 from "figma:asset/c90e0123b0c9694a8a7e5410f30a540d7f9e4d7a.png";
import imgImage31 from "figma:asset/d1a81c329997884332855549bf84957646c3655b.png";
import { imgMain1 } from "./svg-773cq";
...
function Group6() {
  return (
    <div className="absolute contents inset-[-15.23%_-58.02%_73.99%_-7.26%]">
      <div className="absolute flex inset-[-15.23%_-58.02%_73.99%_-7.26%] items-center justify-center">
        <div className="flex-none h-[588.878px] rotate-[261.236deg] w-[248.041px]">
          <div className="[mask-clip:no-clip,_no-clip] [mask-composite:intersect,_intersect] [mask-mode:alpha,_alpha] [mask-repeat:no-repeat,_no-repeat] mask-position-[27.34px,_27.34px_123.671px,_123.671px] mask-size-[374.954px_811.834px,_374.954px_811.834px] opacity-80 relative size-full" data-name="main (1)" style={{ maskImage: `url('${imgMain1}'), url('${imgMain1}')` }}>
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[333.28%] left-[-725%] max-w-none top-[-109.86%] w-[1406.64%]" src={imgMain2} />
            </div>
          </div>
...
function Group7() {
  return (
    <div className="absolute contents inset-[-15.23%_-58.02%_73.99%_-7.26%]">
      <Group6 />
      <div className="[mask-clip:no-clip,_no-clip] [mask-composite:intersect,_intersect] [mask-mode:alpha,_alpha] [mask-repeat:no-repeat,_no-repeat] absolute backdrop-blur-[45px] backdrop-filter bg-gradient-to-b bottom-[73.99%] from-[rgba(252,252,252,0.6)] left-[-0.01%] mask-position-[0.16px,_0.16px_0px,_0px] mask-size-[374.954px_811.834px,_374.954px_811.834px] right-[-0.16%] to-[rgba(255,255,255,0.6)] top-0" style={{ maskImage: `url('${imgMain1}'), url('${imgMain1}')` }} />
    </div>
  );
}
...
function Group8() {
  return (
    <div className="absolute contents inset-[81.27%_-0.06%_-0.01%_0.03%]">
      <div className="absolute flex inset-[81.27%_-0.06%_-0.01%_0.03%] items-center justify-center">
        <div className="flex-none h-[375.153px] rotate-[90deg] skew-x-[359.139deg] w-[146.533px]">
          <div className="[mask-clip:no-clip,_no-clip] [mask-composite:intersect,_intersect] [mask-mode:alpha,_alpha] [mask-repeat:no-repeat,_no-repeat] mask-position-[0px,_0px_-659.933px,_-659.933px] mask-size-[374.954px_811.834px,_374.954px_811.834px] relative size-full" data-name="main (1)" style={{ maskImage: `url('${imgMain1}'), url('${imgMain1}')` }}>
            <div className="absolute inset-0 opacity-75 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[415.76%] left-[-1201.44%] max-w-none top-[-144.82%] w-[1987.8%]" src={imgMain2} />
            </div>
          </div>
...
function Group9() {
  return (
    <div className="absolute contents inset-[66.2%_-0.06%_-0.01%_0.03%]">
      <Group8 />
      <div className="[mask-clip:no-clip,_no-clip] [mask-composite:intersect,_intersect] [mask-mode:alpha,_alpha] [mask-repeat:no-repeat,_no-repeat] absolute backdrop-blur-[45px] backdrop-filter bg-[rgba(254,254,254,0.55)] inset-[66.2%_-0.02%_0.02%_0.03%] mask-position-[0px,_0px_-537.513px,_-537.513px] mask-size-[374.954px_811.834px,_374.954px_811.834px]" style={{ maskImage: `url('${imgMain1}'), url('${imgMain1}')` }} />
    </div>
  );
}
...
function MaskGroup() {
  return (
    <div className="absolute bottom-[0.02%] contents left-[0.03%] right-[-0.02%] top-0" data-name="Mask Group">
      <Group7 />
      <Group9 />
    </div>
  );
...
function BarsHomeIndicatorIPhoneLightPortrait() {
  return (
    <div className="absolute inset-[95.79%_31.73%_0.02%_32.53%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-121.893px_-777.834px] mask-size-[374.954px_811.834px]" data-name="Bars / Home Indicator / iPhone / Light - Portrait" style={{ maskImage: `url('${imgMain1}')` }}>
...
function Navbar() {
  return (
    <div className="absolute h-[116px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0.107px_-699.834px] mask-size-[374.954px_811.834px] top-[699.83px] w-[375px]" data-name="navbar" style={{ maskImage: `url('${imgMain1}')` }}>
      <Group />
...
function Tabs() {
  return (
    <div className="absolute h-[44px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0.107px_-717.834px] mask-size-[374.954px_811.834px] overflow-clip right-0 top-[717.83px]" data-name="Tabs" style={{ maskImage: `url('${imgMain1}')` }}>
      <TabBarItem />
      <TabBarItem1 />
      <Search />
      <TabBarItem2 />
...
function IconmonstrShoppingCart2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="iconmonstr-shopping-cart-2 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="iconmonstr-shopping-cart-2 1">
...
function Tabs1() {
  return (
    <div className="absolute h-[44px] left-[12px] overflow-clip right-[-12px] top-[-11px]" data-name="Tabs">
      <TabBarItem8 />
      <TabBarItem9 />
      <Search2 />
      <TabBarItem10 />
...
function MaskGroup1() {
  return (
    <div className="absolute bottom-[-0.47%] contents left-0 right-[-0.02%] top-0" data-name="Mask Group">
      <Group4 />
      <Group5 />
      <MaskGroup />
...
function ComponentsMobileAppbarSecondery() {
  return (
    <div className="absolute h-[88px] left-0 top-0 w-[375px]" data-name="components/mobile/appbar/secondery">
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[58px] not-italic text-[#37474f] text-[20px] text-nowrap top-[47.32px] whitespace-pre">Snacks</p>
  ...
  return (
    <div className="absolute h-[293px] left-[16px] top-[121px] w-[164px]" data-name="card/product/normal">
      ...
      <div className="absolute inset-[1.71%_15.24%_57%_14.63%] rounded-[9px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-contain pointer-events-none rounded-[9px] size-full" src={imgRectangle1} />
      </div>
      <div className="absolute bottom-[28.33%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">
        <p className="mb-0">Prince Chocolate Half Rolls</p>
        <p>6 pieces</p>
      </div>
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-[62.8%] text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">Rs. 240</p>
...
function CardProductNormal1() {
  return (
    <div className="absolute h-[293px] left-[16px] top-[465px] w-[164px]" data-name="card/product/normal">
      ...
      <p className="absolute bottom-[35.49%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">Nescafe Classic Coffee Jar - 50gm</p>
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-[62.2%] text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">Rs. 560</p>
  ...
  return (
    <div className="absolute h-[293px] left-[195px] top-[121px] w-[164px]" data-name="card/product/normal">
      ...
      <div className="absolute bottom-[35.49%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">
        <p className="mb-0">Lay’s Masala</p>
        <p>&nbsp;</p>
      </div>
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-[69.51%] text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">Rs. 20</p>
...
function CardProductNormal3() {
  return (
    <div className="absolute h-[293px] left-[195px] top-[465px] w-[164px]" data-name="card/product/normal">
      ...
      <p className="absolute bottom-[35.49%] font-['Poppins:Regular',sans-serif] leading-[normal] left-0 not-italic right-0 text-[14px] text-black top-[50.17%]">Euro Muffin Double Chocolate Cake</p>
      <p className="absolute bottom-[16.04%] font-['Poppins:Medium',sans-serif] leading-[normal] left-0 not-italic right-[65.24%] text-[#f37a20] text-[16px] text-nowrap top-[75.77%] tracking-[0.6px] whitespace-pre">Rs. 150</p>
...
function BarsHomeIndicatorIPhoneLightPortrait2() {
  return (
    <div className="absolute bottom-0 left-[32.53%] right-[31.73%] top-[72.36%]" data-name="Bars / Home Indicator / iPhone / Light - Portrait">
      <div className="absolute bg-black bottom-[12.07px] h-[5px] left-1/2 rounded-[100px] translate-x-[-50%] w-[134px]" data-name="Home Indicator" />
    </div>
...
function Navbar1() {
  return (
    <div className="absolute h-[116px] left-0 top-[696px] w-[375px]" data-name="navbar">
      <Group1 />
      <BarsHomeIndicatorIPhoneLightPortrait2 />
    </div>
  );
}

function TabBarItem12() {
  return <div className="absolute h-[44px] left-[calc(50%-149.5px)] top-[2px] translate-x-[-50%] w-[76px]" data-name="Tab Bar Item" />;
}

function IconmonstrShoppingCart3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="iconmonstr-shopping-cart-2 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="iconmonstr-shopping-cart-2 1">
...
function Tabs3() {
  return (
    <div className="absolute h-[44px] left-[7px] overflow-clip right-[-7px] top-[710px]" data-name="Tabs">
      <TabBarItem12 />
      <TabBarItem13 />
      <Search3 />
      <TabBarItem14 />
...
function Menu() {
  return (
    <div className="absolute left-[20px] size-[54px] top-[706px]" data-name="menu">
...
function Group10() {
  return (
    <div className="absolute contents left-[11px] top-[648px]">
      <div className="absolute h-[30px] left-[11px] top-[648px] w-[354px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 354 30">
          <path d={svgPaths.p12e3d980} fill="var(--fill-0, black)" id="Rectangle 33" />
        </svg>
      </div>
      <div className="absolute flex flex-col font-['Poppins:Medium',sans-serif] h-[16px] justify-center leading-[0] left-[188.5px] not-italic text-[16px] text-center text-white top-[665px] translate-x-[-50%] translate-y-[-50%] w-[175px]">
        <p className="leading-[normal]">Item added to Cart!</p>
      </div>
    </div>
  );
}

export default function SnacksConfectionariesAlert() {
  return (
    <div className="bg-white relative size-full" data-name="Snacks & Confectionaries alert">
      <MaskGroup1 />
      ...
      <Content />
      <Group10 />
      <div className="absolute left-[343px] size-[16px] top-[51px]" data-name="image 31">
