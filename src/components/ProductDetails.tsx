  ...
  return (
    <div className="bg-white relative size-full overflow-hidden max-w-[375px] mx-auto" data-name="Product Details home">
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-[375px] mx-auto z-30 bg-white pt-2 pb-[33px]">
        ...
        >
          <div className="absolute flex flex-col font-['Poppins:Medium',sans-serif] justify-center leading-[0] left-1/2 not-italic text-[16px] text-black text-center text-nowrap top-1/2 -translate-x-1/2 -translate-y-1/2">
            <p className="leading-[normal] whitespace-pre">Add to Cart</p>
          </div>
          <div className="absolute right-[16px] size-[24px] top-1/2 translate-y-[-50%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
              <g id="action/bag_24px">
                <path d={svgPaths.p2754f380} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, black)" strokeLinejoin="round" strokeWidth="0.35" />
              </g>
            </svg>
          </div>
        </button>
